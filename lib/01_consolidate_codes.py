...
fndds_16.to_csv('../data/01/fndds_16_consolidated_ingredient_codes.csv', index=None)
fndds_18.to_csv('../data/01/fndds_18_consolidated_ingredient_codes.csv', index=None)
